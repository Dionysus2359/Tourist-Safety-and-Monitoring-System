...
export default function EmergencyContacts() {
  return (
    <div
      className="relative flex flex-col min-h-screen justify-between overflow-x-hidden"
        ...
        >
          <div className="w-full max-w-2xl space-y-8 rounded-2xl bg-black/30 p-8 backdrop-blur-sm">
            ...
            <div className="flex justify-between pt-4">
              ...
              <button className="flex items-center justify-center gap-2 rounded-full bg-[#38e07b] px-6 py-3 text-sm font-bold text-[#111714] transition-colors hover:bg-green-400">
                Next
